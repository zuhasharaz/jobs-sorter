...
// we can convert strings into an object E.G '{z:z}' {z:z} and array as [z:z].
  ...
  // we can loop through the objects keys and can check that if the key is the same as its key value pair,, 
  //we can throw an error message as jobs cant depend on themeselves.
